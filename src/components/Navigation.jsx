  ...
  return (
    <nav className="flex items-center justify-between w-full mb-8">
      <Link to="/" className="flex items-center gap-2">
        <img src="/logo.png" alt="CineSpark" className="w-8 h-8" />
        <span className="text-2xl font-bold text-white">CineSpark</span>
      </Link>
      ...
      <div className="flex items-center gap-3">
        ...
        <Link 
          to="/favorites" 
          className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-all duration-200 cursor-pointer hover:scale-105 ${
